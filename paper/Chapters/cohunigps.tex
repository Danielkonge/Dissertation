...
We note that we skipped some of the details above since we will go through many examples of this kind of computation in \Cref{cha:cohiwagps}, so we refer to there for more details.
